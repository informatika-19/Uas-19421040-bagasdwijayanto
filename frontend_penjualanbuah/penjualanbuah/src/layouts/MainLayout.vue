<template>
  <q-layout view="lHh Lpr lFf">
    <q-header class="bg-deep-yellow-10">
      <q-toolbar>
    <q-btn dense flat round @click="leftDrawerOpen = !leftDrawerOpen" icon="menu"/>
    <q-space></q-space>
    <q-btn flat round>
  <q-avatar>
          <img src="~assets/undraw_male_avatar_323b.png"> />
        </q-avatar>
        <q-menu>
        ...
        <q-list>
          <q-item class="justify-center text-center q-mb-md q-mt-md">
           <div>
            ...
            <div class="text-yellow">Aplikasi Penjualan Buah</div>
           </div>
          </q-item>
          ...
          <q-item clickable active-class="active" v-ripple exact :to="{ name: 'dashboardAdmin' }">
           ...
           <q-item clickable active-class="active" v-ripple exact :to="{ name: 'dataBuah' }">
            <q-item-section avatar>
            <q-icon name="style"/>
            </q-item-section>
            <q-item-section>
            <q-item-label>Data Buah</q-item-label>
            </q-item-section>
          </q-item>
          <q-item clickable active-class="active" :to="{ name: 'inputBarang' }" v-ripple exact>
            ...
            <q-item-section>
            <q-item-label>Input Buah</q-item-label>
            </q-item-section>
          </q-item>
    ...
    <q-page-container class="bg-blue-grey-8">
      <router-view />
    </q-page-container>
  </q-layout>
</template>
